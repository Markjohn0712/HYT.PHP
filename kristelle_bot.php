...
<div class = "trustee-pic mx-auto">
        <img src="./resources/header/kristelle.png">
      </div>
      ...
      <table class = "trustee-title container mx-auto">
        <tr>
          <td>
            <p class="text-4xl text-gray-900 font-extrabold text-center py-0">Kristelle Tabao</p>
          </td>
        </tr>
        ...
        <tr>
          <td>
            <p class="trustee-desc font-bold text-center mx-auto">
              Paralegal, Westwood Law (2019-2021)<br>
              Operations Manager, Klassic Solutions Inc. (2017-2018)         
            </p>
          </td>
        </tr>
      </table>
      ...
      <div class = "trustee-info mx-auto text-center">
          ...
          Presidential Communications Operations Office of the Undersecretary for Special Concerns and Procurement Administrative Officer IV | November 2021 - June 2022
          - Drafts and prepares office documents, including Memoranda, Orders, and other intra-office
          - communications and inter-office/agency communications
          - Maintains systematic filing of all the documents for the Office of the Undersecretary
          - Schedule appointments for the Undersecretary
          - Assists in the GPPB Lectures of the Undersecretary regarding Procurement Law
          - Maintains systematic filing of all the documents for the Office of the Undersecretary
          - Coordinates meetings and prepares minutes of the same
          </p>

          <br>
          <p class = "indent-14 font-medium mx-auto text-justify" style="text-align: justify; width: 1100px;">
          Westwood Law Paralegal | 2019-2021
          - Conducts investigations and statistical and documentary research
          - Conducts legal research
          - Drafts legal correspondence, documents and pleadings
          </p>
          <br>

          <p class = "indent-14 font-medium mx-auto text-justify" style="text-align: justify; width: 1100px;">
          Klassic Solutions Incorporated
