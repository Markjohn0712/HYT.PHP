  ...
  <svg width="1097" height="953" viewBox="0 0 1097 953" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <feGaussianBlur stdDeviation="100" result="effect1_foregroundBlur_58_55"/>
      ...
      <div class = "trustee-pic mx-auto">
        <img src="./resources/header/Ms Heddy.png">
      </div>
      ...
      <table class = "trustee-title container mx-auto">
        <tr>
          <td>
            <p class="text-4xl text-gray-900 font-extrabold text-center py-0">Heddy Yu Tabao</p>
          </td>
        </tr>
        <tr>
          <td>
            <p class="trustee-desc font-bold text-center mx-auto">
              President and CEO of Klassic Group of Companies<br>
              2021-2022
            </p>
          </td>
        </tr>
      ...
      <div class = "trustee-info mx-auto text-center">
          <p class = "font-medium mx-auto text-justify">
            Heddy Yu Tabao earned her bachelor's degree in Economics at Far Eastern University Manila in 1990, which led and enabled her to gradually establish an economy of
            things and incorporate this in business through Klassic Group of Companies. She founded multiple companies with different industries such as Job Contracting, Import and Trading,
            Technology and Innovation, Branding and Marketing, Manufacturing of Softwares and Hardwares, Construction and Project Management, partnered with a Law Firm. She also
            created multiple homebrands that are into Landscaping and Design, Luxurious Cleaning Services, Health and Beauty Drip and Custom-made uniforms and materials. 
          </p>
          ...
          <p class = "indent-14 font-medium mx-auto text-justify" style="text-align: justify; width: 1100px;">
            She was the Past President of Rotary Club of Midtown Quezon City, Past President of Innerwheel Club of San Francisco del Monte District 378 - Quezon City, Past President of Business Network International and currently the Chairman of Business Connect 
            International and the President and CEO of the Klassic Group of Companies. 
          </p>
          ...
          <p class = "indent-14 font-medium mx-auto text-justify" style="text-align: justify; width: 1100px;">
          These organizations, companies, along with its homebrands, aided and motivated her to come to the aid of more people: providing jobs, advocating for the youth, believing in
          their skills and beliefs, and empathizing with these individuals. She is passionate in
          supporting and aiding the masses, irregardless of their struggles about their endeavors. She has realized that assisting people to further develop and carry on to their next phase in life will change one's perspective of their current self. She aims to provide more jobs and


      <br><br><br><br>
      <!-- red line -->
      <div class = "items-center" style="margin-left:15%">  
