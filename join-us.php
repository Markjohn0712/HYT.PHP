...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;800;900display=swap" rel="stylesheet">
    <!-- END OF CSS FILES -->
  </head>
  <body>
    <section class="section-hero">
      ...
      <nav class="w-full fixed top-0 bg-white z-10 dark:bg-slate-900">
        <div class="container mx-auto py-5 flex items-center justify-between">
          ...
          <ul
            class="hidden md:flex space-x-10 text-black dark:text-gray-100 font-bold text-sm uppercase"
          >
            ...
            <button
              class="green-button hover:bg-lime-500 text-white font-bold py-1 px-3 rounded-full"
            ><a href="join-us.php">JOIN US</a>

            </button>
            <button
              class="black-button hover:bg-black text-white font-bold py-1 px-3 rounded-full"
            >
              DONATE
            </button>    
          </ul>      
          <ul
            id="menu"
            class="hidden bg-black absolute left-0 top-0 w-full p-10 rounded-b-3xl space-y-10 text-white text-center"
          >
            <li>
              <a id="hLink" href="#">HOME</a>
            </li>
            <li>
              <a id="hLink" href="#">ABOUT US</a>
            </li>
            <li>
              <a id="hLink" href="#">DREAM ACADEMY</a>
            </li>
            <li>
              <a id="hLink" href="#">OUR THRUST</a>
            </li>
            <li>
              <a id="hLink" href="#">CONTACT US</a>
            </li>
          </ul>
        </div>
      </nav>
...
<div id="works" class="py-40 dark:bg-slate-900">
  <div class="container mx-auto">
    ...
    <div class="flex flex-col gap-3 items-center">
      <img src="./resources/header/joinus.png" class="h-25 mr-3"alt="Flowbite Logo"/>
      <h1 class="text-3xl dark:text-white">Join Us</h1>
      <p class="w-1/2 text-center text-gray-400">
        Quality education is for all. As we pursue for a better tomorrow, we must nurture our dreamers upon a strong educational foothold. 
                    And, with that, HYT Foundation has come up with several programs that would bring quality education even to the most unfortunate.
      </p>
    </div>
    ...
    <tr>
        <td class="join_map text-center" colspan="2">      
        </td>
    </tr>
  </table>
  ...
  <table class="contact-table mx-auto">
    <tr>
        <td>
            ...
            <br><br><br>
            <div class="contact-details text-xs">
                <b class="font-bold text-3xl">Contact Number</b><br>
                (02) 835 90648(63)<br>
                961 495 8696(63)<br>
                905 102 4246
            </div>
        ...
        <td style="width:40px; background-color:transparent;"></td>
        ...
        <td>
            ...
            <div class="contact-details text-xs">
                <b class="font-bold text-3xl">Email Address</b><br>
                hello@brains.asia
            </div>
        </td>
        ...
        <td>
            ...
            <br><br><br>
            <div class="contact-details text-xs">
                <b class="font-bold text-3xl">Address</b><br>
                Suite 1004 Atlanta Center, Annapolis St.,<br>
