...
<!-- PROFILE -->
    <div class = "trustee-pic mx-auto">
        <img src="./resources/header/Engineer Bryan.png">
      </div>
      <br>
      <table class = "trustee-title container mx-auto">
        <tr>
          <td>
            <p class="text-4xl text-gray-900 font-extrabold text-center py-0">Engr. Bryan Tañagras, CBE, CDCP</p>
          </td>
        </tr>
        ...
        <tr>
          <td>
            <p class="trustee-desc font-bold text-center mx-auto">
              Chairman/CEO, Z Corp.<br>
              Founder/President, BYTES IT Consultancy<br>
              CTO, Brains Infinite Innovations Inc.              
            </p>
          </td>
        </tr>
      </table>
      ...
      <div class = "trustee-info mx-auto text-center">
          <p class = "font-medium mx-auto text-justify">
            A graduate from Siliman University in 2009, registered Electronics Engineer, 
            Certified Blockchain Expert, Certified Data Center Professional, a solutions architect, and a technopreneur.
          </p>

          <br>

          <p class = "indent-14 font-medium mx-auto text-justify" style="text-align: justify; width: 1100px;">
            His interests are into programming, having developed games, systems automation, P2E, NFT, crypto, Metaverse for ARVR, and pioneering AIML for startup ventures.
          </p>

          <br>

          <p class = "indent-14 font-medium mx-auto text-justify" style="text-align: justify; width: 1100px;">
            At the age of 29, he has ventured multiple areas of consultancies with startup and multinational firms. 
            Currently, he is wearing multiple hats as Co-Founder and CTO to not less than 10 institutions.
          </p>

          <br>

          <p class = "indent-14 font-medium mx-auto text-justify" style="text-align: justify; width: 1100px;">
            He provides free technical trainings and seminars to the universities in the Philippines 
            to promote innovations in all aspects applicable to boost the youth as early adopters for the emerging glass generation.
          </p>

          <br>

          <p class = "indent-14 font-medium mx-auto text-justify" style="text-align: justify; width: 1100px;">
            Together with the Klassic Group of Companies and Helping Youth Transcend Foundation Inc., 
            he aims to empower the Filipinos to be globally competitive and provide resources for them to promote livelihood for the Filipinos. 
          </p>

          <br>

          <p class = "indent-14 font-medium mx-auto text-justify" style="text-align: justify; width: 1100px;">
            Innovating the workforce using technology is one of his advocacies to promote good Environmental, Social, 
            and Governance scoring to elevate our overall global rating as one of the top service providers in the world.
          </p>
        </p>
      </div>
      ...
      <table class="know-more-table mx-auto">
        ...
        <tr>
          ...
          <td>
            ...
            <img src="./resources/header/Engineer Bryan.pn">
          </td>
        </tr>
