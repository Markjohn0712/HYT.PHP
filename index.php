...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="./resources/header/HYT Logo.png" type="image/gif/png">
    <!-- END OF CSS FILES -->
    <section class="section-dreamacademy">
      ...
      <body>
        <nav class="w-full fixed top-0 bg-white z-10 dark:bg-slate-900">
          <div class="container mx-auto py-5 flex items-center justify-between">
            ...
            <button
              class="black-button hover:bg-black text-white font-bold py-1 px-3 rounded-full"> <a href="#">DONATE
            </button>  
            <button
              class="black-button hover:bg-red-500 text-white font-bold py-1 px-3 rounded-full"> <a href="logout.php">LOG OUT 
            </button>  
      ...
      <main>
        <div class="container-local">
          <div class="hero">
            <div class="hero-text">
              <p class="title-2">BRINGING THE NEXT</p>
              <p class="title-2">GENERATION</p>
              <p class="title-1">FORWARD</p>            
            </div>

            <div class="overlay"></div>
            <video autoplay muted loop class="video-bg">
              <source
                src="./resources/videos/index/pexels-pressmaster-3209211-3840x2160-25fps.mp4"
                type="video/mp4"
              />
            </video>
          </div>
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3" style="padding-right: 100px;">
            <div>
                ...
                <ul class="text-white">
                    ...
                    <li class="mb-1">
                      <a href="dreamacademy" class="hover:underline">Dream Academy</a>
                    </li>
                    <li class="mb-1">
